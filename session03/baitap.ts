...
function addContact(contact1:Contact) {
...
function updateContact(id:number , value:Contact) {
...
//Bai5:
function bai5(start:number , end:number) {
    let text:string = ''
...
function bai6(a:number , b:number) {
    return a * b
}
